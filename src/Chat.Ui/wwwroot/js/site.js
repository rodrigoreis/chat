...
function createChatController() {
    ...
    return {
        ...
        connectUserToChat: function () {
            ...
            startConnection(this).then(r => console.log('connection is open'));
        },
        sendMessage: function (to) {
            ...
            // responsável por inserir a mensagem no chat
...
// responsável por realizar a conexão do usuário no nosso Hub
async function startConnection(chat) {
    try {
        ...
        await loadChat(chat.connection);
...
// responsável por iniciar um novo chat
...
// responsável por capturar a mensagem e enviar
